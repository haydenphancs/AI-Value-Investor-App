...
--
-- Name: add_chat_tokens(uuid, date, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.add_chat_tokens(p_user_id uuid, p_day date, p_tokens integer) RETURNS bigint
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: claim_chat_turn(uuid, date, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.claim_chat_turn(p_user_id uuid, p_day date, p_turn_limit integer) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
CREATE FUNCTION public.claim_updates_insight_scope(p_scope text, p_now timestamp with time zone, p_stale_seconds integer, p_attempt_cap integer, p_daily_cap integer) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
CREATE FUNCTION public.ensure_credit_period(p_user_id uuid) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
--
-- Name: increment_ai_insight_budget(date, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_ai_insight_budget(p_day date, p_limit integer) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
CREATE FUNCTION public.increment_updates_insight_success(p_scope text) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
--
-- Name: release_chat_turn(uuid, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.release_chat_turn(p_user_id uuid, p_day date) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
CREATE FUNCTION public.spend_credits(p_user_id uuid, p_amount integer, p_reason text, p_ref_id text) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    SET row_security TO 'off'
    AS $$
...
--
-- Name: ai_insight_budget; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ai_insight_budget (
...
--
-- Name: ai_insight_cache; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.ai_insight_cache (
    ...
    close_cycle timestamp with time zone NOT NULL,
    soft_expires_at timestamp with time zone NOT NULL,
    hard_expires_at timestamp with time zone NOT NULL,
    price_move jsonb,
    sources jsonb,
    CONSTRAINT ai_insight_article_count_check CHECK ((article_count >= 0)),
    CONSTRAINT ai_insight_bullets_check CHECK (((jsonb_typeof(bullets) = 'array'::text) AND ((jsonb_array_length(bullets) >= 2) AND (jsonb_array_length(bullets) <= 5)))),
    CONSTRAINT ai_insight_expiry_order_check CHECK ((soft_expires_at <= hard_expires_at)),
    CONSTRAINT ai_insight_headline_check CHECK (((char_length(headline) >= 1) AND (char_length(headline) <= 240))),
    CONSTRAINT ai_insight_scope_check CHECK (((char_length(scope) >= 1) AND (char_length(scope) <= 32))),
    CONSTRAINT ai_insight_sentiment_check CHECK ((lower(sentiment) = ANY (ARRAY['bullish'::text, 'bearish'::text, 'neutral'::text])))
);


--
-- Name: ai_insight_cache_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_insight_cache_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: ai_insight_cache_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_insight_cache_id_seq OWNED BY public.ai_insight_cache.id;
...
--
-- Name: COLUMN chat_sessions.context_type; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.chat_sessions.context_type IS 'Screen the chat is grounded on (ChatContextType): TICKER_REPORT, STOCK, ETF, CRYPTO, INDEX, COMMODITY, MONEY_MOVES_ARTICLE, JOURNEY_LESSON, BOOK, NONE. NULL for legacy/general chats.';


--
-- Name: COLUMN chat_sessions.reference_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.chat_sessions.reference_id IS 'Identifier the ChatContextResolver fetches by: ticker, "TICKER|persona" (reports), article slug, book curriculum order, etc. NULL when context_type is NONE/absent.';


--
-- Name: COLUMN chat_sessions.context_snapshot; Type: COMMENT; Schema: public; Owner: -
--
...
CREATE TABLE public.chat_usage_budget (
    user_id uuid NOT NULL,
    budget_day date NOT NULL,
...
--
-- Name: earnings_cache; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: growth_cache; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ticker_volatility_cache; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ticker_volatility_cache (
    ticker text NOT NULL,
...
--
-- Name: updates_insight_state; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.updates_insight_state (
    id bigint NOT NULL,
    scope text NOT NULL,
    ...
    close_cycle timestamp with time zone,
    regen_day date,
    regen_count_today integer DEFAULT 0 NOT NULL,
    attempts_today integer DEFAULT 0 NOT NULL,
    last_failure_at timestamp with time zone,
    last_error text,
    claim_at timestamp with time zone,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT updates_insight_state_scope_check CHECK (((char_length(scope) >= 1) AND (char_length(scope) <= 32)))
);


--
-- Name: updates_insight_state_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.updates_insight_state_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: updates_insight_state_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.updates_insight_state_id_seq OWNED BY public.updates_insight_state.id;
...
--
-- Name: ai_insight_cache id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_insight_cache ALTER COLUMN id SET DEFAULT nextval('public.ai_insight_cache_id_seq'::regclass);
...
--
-- Name: updates_insight_state id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: ai_insight_budget ai_insight_budget_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_insight_budget
    ADD CONSTRAINT ai_insight_budget_pkey PRIMARY KEY (budget_day);


--
-- Name: ai_insight_cache ai_insight_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_insight_cache
    ADD CONSTRAINT ai_insight_cache_pkey PRIMARY KEY (id);


--
-- Name: ai_insight_cache ai_insight_cache_scope_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.chat_usage_budget
    ADD CONSTRAINT chat_usage_budget_pkey PRIMARY KEY (user_id, budget_day);
...
--
-- Name: earnings_cache earnings_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: growth_cache growth_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ticker_volatility_cache ticker_volatility_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ticker_volatility_cache
    ADD CONSTRAINT ticker_volatility_cache_pkey PRIMARY KEY (ticker);
...
--
-- Name: updates_insight_state updates_insight_state_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.updates_insight_state
    ADD CONSTRAINT updates_insight_state_pkey PRIMARY KEY (id);


--
-- Name: updates_insight_state updates_insight_state_scope_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_ai_insight_cache_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_insight_cache_expiry ON public.ai_insight_cache USING btree (hard_expires_at);
...
--
-- Name: idx_chat_usage_budget_day; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_chat_usage_budget_day ON public.chat_usage_budget USING btree (budget_day);
...
--
-- Name: idx_earnings_cache_ticker; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_growth_cache_ticker; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_growth_cache_ticker ON public.growth_cache USING btree (ticker);
...
CREATE INDEX idx_subscriptions_expiry ON public.subscriptions USING btree (status, current_period_end);


--
-- Name: idx_subscriptions_txn; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subscriptions_txn ON public.subscriptions USING btree (original_transaction_id);
...
--
-- Name: idx_ticker_volatility_cache_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ticker_volatility_cache_expiry ON public.ticker_volatility_cache USING btree (expires_at);
...
--
-- Name: idx_updates_insight_state_due; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_updates_insight_state_due ON public.updates_insight_state USING btree (last_evaluated_at) WHERE (claim_at IS NULL);


--
-- Name: idx_updates_insight_state_watch; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ai_insight_budget; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.ai_insight_budget ENABLE ROW LEVEL SECURITY;

--
-- Name: ai_insight_budget ai_insight_budget_service_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ai_insight_budget_service_all ON public.ai_insight_budget TO service_role USING (true) WITH CHECK (true);


--
-- Name: ai_insight_cache; Type: ROW SECURITY; Schema: public; Owner: -
--
...
ALTER TABLE public.chat_usage_budget ENABLE ROW LEVEL SECURITY;

--
-- Name: chat_usage_budget chat_usage_budget_service_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY chat_usage_budget_service_all ON public.chat_usage_budget TO service_role USING (true) WITH CHECK (true);
...
--
-- Name: credit_transactions credit_transactions_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: earnings_cache; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.earnings_cache ENABLE ROW LEVEL SECURITY;

--
-- Name: earnings_cache earnings_cache_service_role_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY earnings_cache_service_role_all ON public.earnings_cache TO service_role USING (true) WITH CHECK (true);
...
--
-- Name: growth_cache; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.growth_cache ENABLE ROW LEVEL SECURITY;

--
-- Name: growth_cache growth_cache_service_role_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY growth_cache_service_role_all ON public.growth_cache TO service_role USING (true) WITH CHECK (true);
...
--
-- Name: plan_credits; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.plan_credits ENABLE ROW LEVEL SECURITY;

--
-- Name: plan_credits plan_credits_public_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY plan_credits_public_read ON public.plan_credits FOR SELECT TO authenticated, anon USING (true);


--
-- Name: plan_credits plan_credits_service_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ticker_volatility_cache; Type: ROW SECURITY; Schema: public; Owner: -
--
...
CREATE POLICY ticker_volatility_cache_service_write ON public.ticker_volatility_cache TO service_role USING (true) WITH CHECK (true);
...
--
-- Name: updates_insight_state; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.updates_insight_state ENABLE ROW LEVEL SECURITY;

--
-- Name: updates_insight_state updates_insight_state_service_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY updates_insight_state_service_all ON public.updates_insight_state TO service_role USING (true) WITH CHECK (true);
...
CREATE POLICY user_settings_service_all ON public.user_settings TO service_role USING (true) WITH CHECK (true);
