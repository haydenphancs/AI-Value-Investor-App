...
BOOK_VOICES: dict[int, dict] = {
    ...
    2:  {"voice": "Iapetus",       "wpm": 150, "style": "Read this as an erudite, classically-educated finance professor — articulate, precise, emotionally detached and measured, with dry wit and dignified, calm authority. "},  # matches the 1_erudite_professor_Iapetus audition (descriptor, never "narrate as <person>")
    3:  {"voice": "Puck",          "wpm": 172, "style": "Read this as a calm, thoughtful modern essayist — reflective, intimate and understated, with gentle pacing. "},  # matches the 4_modern_essayist_Puck audition (a person-name direction pulled Puck off-character)
