    ...
    func toggleFavorite() {
        ...
        Task { @MainActor in
            do {
                ...
                // with the STORED spelling (the pair: migration 160), which is what the feed
                // rows carry; a bare `BTC` names the Grayscale ETF, not the coin.
                ...
                PortfolioStore.announceWatchlistChange(
                    ticker: CryptoSymbol.pair(cryptoSymbol), assetType: "crypto",
