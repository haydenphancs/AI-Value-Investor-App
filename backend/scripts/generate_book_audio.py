...
BOOK_VOICES: dict[int, dict] = {
    ...
    2:  {"voice": "Iapetus",       "wpm": 150, "style": "Read this as an erudite, classically-educated finance professor — precise, measured and dignified, with dry wit and calm authority. "},
    3:  {"voice": "Puck",          "wpm": 172, "style": "Read this as a calm, thoughtful modern essayist — reflective and intimate, with gentle, understated pacing. "},
    ...
    8:  {"voice": "Zubenelgenubi", "wpm": 160, "style": "Read this as a warm, wise, plain-spoken older man — patient and unhurried, with gentle good humor, in a neutral American accent, not a strong regional or folksy twang. "},
